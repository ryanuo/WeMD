export const verdantTheme = `/* 萌绿风格 */
#wemd {
  font-family:
...
#wemd h1 {
  ...
  padding: 0px;
  background: url(https://edit.wemd.app/themes/verdant/koala-1.png) center
    center / 75px no-repeat scroll padding-box border-box transparent;
  width: auto;
  height: auto;
  align-items: unset;
  border-style: none;
...
#wemd h1 .content {
  font-size: 18px;
  color: rgb(72, 179, 120);
  line-height: 2.4em;
  letter-spacing: 0em;
  margin: 38px 0px 10px;
  border-style: none none solid;
  border-width: 1px 1px 2px;
  border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(46, 121, 80);
  border-radius: 0px;
  align-items: unset;
...
#wemd h2 {
  margin: 30px 0px 15px;
  padding: 0px;
  background: url(https://edit.wemd.app/themes/verdant/koala-2.png) center
    center / 63px no-repeat scroll padding-box border-box transparent;
  width: auto;
  height: auto;
  align-items: unset;
  border-style: none;
...
/* 三级标题前缀 */
#wemd h3 .prefix {
  background: url(https://edit.wemd.app/themes/verdant/koala-3.png) 0% 0% / 15px
    15px no-repeat scroll padding-box border-box transparent;
  width: 15px;
  height: 15px;
  align-items: unset;
  border-style: none;
...
#wemd .footnote-word {
  color: #48b378;
  font-weight: 500;
  border-bottom: 1px dashed #48b378;
}
